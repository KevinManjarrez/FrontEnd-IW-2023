...
const OrdenesStatusNavTab  = ({ currentRowInOrdenesStatusTab, setCurrentNameTabInOrdenesStatusTab }) => {
        ...
        <Box sx={{ border: (theme) => `1px solid ${theme.palette.divider}`, mx: 1, padding: 0.5 }}>
            ...
            >
                {BusinessTabs.map((tab) => {
                    return <Tab key={tab} label={tab} disabled={currentRowInOrdenesStatusTab === null} />;
                })} 
            </Tabs>
        </Box>
    );
