...
export default function OrdenesStatusTab() {
  ...
  const [currentRowInOrdenesStatusTab, setCurrentRowInOrdenesStatusTab] = useState(0);   
 
  //FIC: indicamos que el estado inicial del tab page principal por default sera INSTITUTOS.

  const [currentNameTabInOrdenesStatusTab, setCurrentNameTabInOrdenesStatusTab] = useState("ORDENES_STATUS");
 
  return (
      <Box> 
            <BusinessNavTab
                currentRowInOrdenesStatusTab={currentRowInOrdenesStatusTab} 
                setCurrentNameTabInOrdenesStatusTab={setCurrentNameTabInOrdenesStatusTab} 
            />
