...
export default function OrdenesDetalleTab() {
  ...
  const [currentRowDetalleInBusinessTab, setCurrentRowDetalleInBusinessTab] =
    useState(0);

  //FIC: indicamos que el estado inicial del tab page principal por default sera INSTITUTOS.

  const [currentDetalleTabInBusinessTab, setCurrentDetalleTabInBusinessTab] =
    useState("ORDENES_DETALLES");
  ...
  return (
    <Box>
      ...
      {currentDetalleTabInBusinessTab == "Orden Detalle" && (
        <OrdenesDetalleSubTab />
      )}
